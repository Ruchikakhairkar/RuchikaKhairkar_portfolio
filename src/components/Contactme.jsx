...
//   return (
//     <>
//       <section className="container mx-auto px-6 py-12 h-screen bg-cover bg-center ">
...
const Contactme = () => {
  ...
  return (
    <>
      <section className="container mx-auto px-6 py-12 min-h-screen bg-cover bg-center">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold">Get In Touch</h1>
        </div>
        <div className="md:flex justify-center">
